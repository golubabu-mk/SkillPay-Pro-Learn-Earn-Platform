      ...
      <div className="mb-3">
        <div className="flex items-baseline justify-between mb-1">
          <span className="font-mono text-sm text-ledger-ink">
            {(challenge.rewardAmount || 0).toLocaleString()} {challenge.rewardCurrency || "XLM"} <span className="text-[10px] text-ledger-inkMuted/70 ml-1">(~${((challenge.rewardAmount || 0) * (challenge.rewardCurrency === "USDC" ? 1 : 0.12)).toFixed(2)})</span>
